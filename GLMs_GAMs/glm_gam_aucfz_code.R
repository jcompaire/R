...
pk <- c("comprehenr", "dplyr", "effects", "formula.tools", "ggplot2", "ggpubr",
        ...
        "raster", "readxl","rnaturalearth", "rlist",
        "scales", "stats", "stringr")
...
setwd("~/GoogleDrive/GitHub/R/GLMs_GAMs/") # directory
...
head(bathy)
# Saving plot
tiff("Fig1_Map_1000dpi.tiff", width=9, height=6, units="in",
...
# Merging plots ---------------------------------------------------------------
tiff("Fig2_GLMs_summarized_1000dpi.tiff", width=12, height=6, units="in",
     res=1000, compression="lzw")
...
# 
tiff("Fig4_GLM_selected_R1_1000dpi.tiff", width=12, height=6, units="in",
     res=1000, compression="lzw")
# file_name = paste0(file = output , "Fig4_GLM_selected_R1",
#                    ".pdf", sep="")
# pdf(file_name, width=12, height=6, bg = "transparent", colormodel = "cmyk")
par(mfcol=c(1,1))
...
# Merging plots ---------------------------------------------------------------
tiff("Fig3_GAMs_summarized_1000dpi.tiff", width=12, height=6, units="in",
     res=1000, compression="lzw")
...
tiff("Fig5_GAM_selected_R1_1000dpi.tiff", width=12, height=6, units="in",
     res=1000, compression="lzw")
# file_name = paste0(file = output , "Fig5_GAM_selected_R1",
#                    ".pdf", sep="")
# pdf(file_name, width=12, height=6, bg = "transparent", colormodel = "cmyk")
par(mfcol=c(1,1))
